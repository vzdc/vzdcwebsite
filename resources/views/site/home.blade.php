    ...
    <div class="container">
        <div class="jumbotron" style="opacity:0.75">
            <div class="row">
                <div class="col-sm-8">
                    <h1><b>vZDC</b></h1>
                    <h5>Welcome to the Washington Virtual ARTCC website. This website is for a group of online hobbyists who partake in simulated flying and air traffic control on the VATSIM network.</h5>
