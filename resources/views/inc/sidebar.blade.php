<div class="card bg-light card-body" id="pill-sidebar">
    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical" style="margin-left:20px;">
        ...
        @endif
        @if(Auth::user()->can('staff') || Auth::user()->can('email') || Auth::user()->can('scenery') ||
        Auth::user()->can('files') || Auth::user()->can('events'))
        <div class="dropdown-divider"></div>
        ...
        <div class="content">
            ...
            @endif
            @if(Auth::user()->can('snrStaff'))
            <a class="nav-link {{ Nav::urlDoesContain('dashboard/admin/loas') }}" href="/dashboard/admin/loas">LOA
                Center</a>
            @endif
            @if(Auth::user()->can('snrStaff'))
