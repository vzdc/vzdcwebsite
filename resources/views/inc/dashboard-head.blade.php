    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" style="pointer-events:none">{{ Auth::user()->full_name }}
...
<div class="modal fade" id="unOpt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <br>
            <div class="container">
                <p>Please note that opting out of broadcast emails will only prevent you from receiving broadcast emails
                    issued from staff. Personalized emails (both automated and issued by staff) will not be affected. If
                    you have any questions, please contact the ATM at <a href="mailto:atm@vzdc.org">atm@vzdc.org</a>.
                </p>
            </div>
...
<div class="modal fade" id="Opt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <br>
            <div class="container">
                <p>Opting into emails will only affect the recieving of mass emails. If you elect to opt into emails,
                    you agree to recieve mass emails sent to groups of members of the vZDC ARTCC. This selection will
                    not affect the reception of personalized emails (both automated and issued by staff) for example,
                    training ticket emails. If you have any questions, please contact the ATM at <a
                            href="mailto:atm@vzdc.org">atm@vzdc.org</a>.</p>
                <p>You may opt out at any time by using the slider shown at the top of the controller dashboard at all
                    times.</p>
                <br>
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('opt', 'I agree to recieve mass emails from the vZDC ARTCC.', ['class' => 'form-label']) !!}
                    <br>
                    {!! Form::checkbox('privacy', '1', false) !!}
                    {!! Form::label('privacy', 'I have read and agree to the vZDC ARTCC Privacy Policy.', ['class' => 'form-label']) !!}
                </div>
            </div>
            <div class="modal-footer">
                <a href="{{ url()->current() }}" class="btn btn-secondary">Close</a>
