...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-8">
                    <h3>Something just happened that wasn't supposed to happen and we're really not sure why! Please kindly report this error to <a href="mailto:wm@vzdc.org">wm@vzdc.org</a> with descriptive steps to reproduce and a link to the page. Thank you for your help!</h3>
                    <br>
