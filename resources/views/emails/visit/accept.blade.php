...
@section('content')
    ...
    <p>You can find all the information for the various facilities within the ARTCC website under the files page, <a href="http://www.vzdc.org/%22%3Ewww.vzdc.org</a>.</p><br>
