            ...
            <div class="block-heading-two">
                <h4>
                    ...
                    @else
                        ...
                        @endforeach
                    @endif
                    &nbsp;<a href="mailto:ata@vzdc.org" style="color:black"><i class="fa fa-envelope"></i></a>
                </h4>
            </div>
            <hr>
        @endif
            ...
            <div class="block-heading-two">
                <h4>
                    ...
                    @else
                        ...
                        @endforeach
                    @endif
                    &nbsp;<a href="mailto:awm@vzdc.org" style="color:black"><i class="fa fa-envelope"></i></a>
                </h4>
            </div>
            <hr>
        @endif
        <div class="block-heading-two">
            <h4>
                ...
                @else
                    ...
                    @endforeach
                @endif
                &nbsp;<a href="mailto:events@vzdc.org" style="color:black"><i class="fa fa-envelope"></i></a>
            </h4>
        ...
        <div class="block-heading-two">
            <h4>
                ...
                @else
                    ...
                    @endforeach
                @endif
                &nbsp;<a href="mailto:facilities@vzdc.org" style="color:black"><i class="fa fa-envelope"></i></a>
            </h4>
