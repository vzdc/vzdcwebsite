        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <ul>
                    ...
                    <li>Teamspeak permissions are assigned by VATSYNC - Please signup via VATSYNC to get your assigned
                        permissions. Staff Members will NOT assign permissions. Please visit <a
                                href="https://vatsimsync.com/">https://vatsimsync.com/</a> and setup your unique ID with
                        this server.
                    </li>
                    <li>Streaming while controlling is allowed and encouraged although the audio from the teamspeak is
                        ...
                        permission). Streaming audio without his/her permission may result in loss of teamspeak
                        privileges.
                    </li>
                    <li>Controlling rooms are limited to controlling only. If a controller asks for you to leave, please
                        do so.
                    </li>
                    <li>Use of the teamspeak is a privilage and can be revoked by a staff member at any time and for any
