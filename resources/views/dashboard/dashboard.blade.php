    ...
    <div class="container-fluid">
        @if($announcement->body != null)
            <div class="alert alert-success">
                {!! $announcement->body !!}
                <hr>
                <p class="small"><i>Last updated by {{ $announcement->staff_name }}
                        on {{ $announcement->update_time }}</i></p>
            </div>
            <hr>
        @endif
        <div class="row">
            <div class="col-sm-3">
                <div class="card card-body" style="background-color:lightgrey">
                    <center><h5>Jared West Time Now:</h5></center>
                    <center>
                        <iframe style="pointer-events: none"
                                src="https://freesecure.timeanddate.com/clock/i6kynk0j/n75/fs16/tct/pct/bas6/bat6/bac777/pa8/tt0/tm2/th1/ta1/tb4"
                                frameborder="0" width="200" height="64" allowTransparency="true"></iframe>
                    </center>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card card-body" style="background-color:lightgrey">
                    ...
                    <center>
                        <iframe style="pointer-events: none"
                                src="https://freesecure.timeanddate.com/clock/i6hnccu7/n407/fs16/tct/pct/bas6/bat6/bac777/pa8/tt0/tm2/th1/ta1/tb4"
                                frameborder="0" width="200" height="64" allowTransparency="true"></iframe>
                    </center>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card card-body" style="background-color:lightgrey">
                    ...
                    <center>
                        <iframe style="pointer-events: none"
                                src="https://freesecure.timeanddate.com/clock/i6hnccu7/n25/fs16/tct/pct/bas6/bat6/bac777/pa8/tt0/tm2/th1/ta1/tb4"
                                frameborder="0" width="200" height="64" allowTransparency="true"></iframe>
                    </center>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card card-body" style="background-color:lightgrey">
                    ...
                    <center>
                        <iframe style="pointer-events: none"
                                src="https://freesecure.timeanddate.com/clock/i6hnccu7/fs16/tct/pct/bas6/bat6/bac777/pa8/tt0/tm2/th1/ta1/tb4"
                                frameborder="0" width="200" height="64" allowTransparency="true"></iframe>
                    </center>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <button data-toggle="modal" data-target="#reportBug" class="btn btn-secondary btn-block">Report a Bug
                </button>
                @if(Auth::user()->can('staff'))
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                @if(count($news) > 0)
                    @foreach($news as $c)
                        <p>{{ $c->date }} - <b>{{ $c->title }}</b> <a
                                    href="/dashboard/controllers/calendar/view/{{ $c->id }}">(View)</a></p>
                    @endforeach
                @else
            ...
            <div class="col-sm-4">
                <center><h4><a href="/dashboard/controllers/events" style="color:inherit;text-decoration:none"><i
                                    class="fas fa-plane"></i> Events</a></h4></center>
                @if($events->count() > 0)
                    @foreach($events as $e)
                        <a href="/dashboard/controllers/events/view/{{ $e->id }}"><img src="{{ $e->banner_path }}"
                                                                                       width="100%"
                                                                                       alt="{{ $e->name }}"></a>
                        <p></p>
                    @endforeach
        ...
        <hr>
        <center><h2><i class="fa fa-microphone" style="color:#C9AE5D"></i> Bronze Mic Award <i class="fa fa-microphone"
                                                                                               style="color:#C9AE5D"></i>
            </h2></center>
        <div class="row">
            <div class="col-sm-6">
                <div class="row">
        ...
        <hr>
        <center><h2><i class="fa fa-microphone" style="color:#FFDF00"></i> Pyrite Mic Award for 20{{ $lyear }} <i
                        class="fa fa-microphone" style="color:#FFDF00"></i></h2></center>
        <div class="row">
            <div class="col-sm-4">
            </div>
            <div class="col-sm-4">
        ...
        <div class="modal fade" id="reportBug" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
