...
<div class="container">
    <ul class="nav nav-tabs nav-justified" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#processed" role="tab" data-toggle="tab" style="color:black">Processed
                Feedback</a>
        </li>
    </ul>
        ...
        <div role="tabpanel" class="tab-pane active" id="new">
            ...
            <table class="table table-outline">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span data-toggle="modal" data-target="#saveFeedback{{ $f->id }}">
                                <button type="button" class="btn btn-success simple-tooltip" data-placement="top"
                                    data-toggle="tooltip" title="Save Feedback"><i class="fas fa-check"></i></button>
                            </span>
                            ...
                            <span data-toggle="modal" data-target="#emailFeedback{{ $f->id }}">
                                <button type="button" class="btn btn-warning simple-tooltip" data-placement="top"
                                    data-toggle="tooltip" title="Email Pilot"><i class="fas fa-envelope"></i></button>
                            </span>
                            @endif
                        </td>
                    </tr>

                    <div class="modal fade" id="saveFeedback{{ $f->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            {!! Form::select('controller_id', $controllers, $f->controller_id, ['class'
                                            => 'form-control']) !!}
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    {!! Form::textArea('staff_comments', $f->staff_comments, ['class' =>
                                    'form-control']) !!}
                                </div>
                    ...
                    <div class="modal fade" id="hideFeedback{{ $f->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <div class="modal fade" id="emailFeedback{{ $f->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    {!! Form::text('subject', 'An email regarding your recent feedback', ['class' =>
                                    'form-control']) !!}
                                    <br>
                                    {!! Form::label('body', 'Message') !!}
                                    {!! Form::textArea('body', null, ['placeholder' => 'Gander Center, Pass your
            ...
            <table class="table table-outline">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><b>{{ $f->position }}</b> ({{ $f->service_level_text }})</td>
                        <td>{{ $f->controller_name }}</td>
                        <td data-toggle="tooltip" title="{{ $f->comments }}">{{ str_limit($f->comments, 40, '...') }}
                        </td>
                        <td data-toggle="tooltip" title="{{ $f->staff_comments }}">
                            {{ str_limit($f->staff_comments, 40, '...') }}</td>
                        <td>{{ $f->created_at }}</td>
                        <td>@if($f->contacted == 1)
                        ...
                        <td>
                            <div class="row">
                                <span data-toggle="modal" data-target="#updateFeedback{{ $f->id }}">
                                    <button type="button" class="btn btn-success simple-tooltip" data-placement="top"
                                        data-toggle="tooltip" title="Update Feedback"><i
                                            class="fas fa-pencil-alt"></i></button>
                                </span>
                                @if($f->pilot_email != null)
                                <span data-toggle="modal" data-target="#emailFeedback{{ $f->id }}">
                                    <button type="button" class="btn btn-warning simple-tooltip" data-placement="top"
                                        data-toggle="tooltip" title="Email Pilot"><i
                    ...
                    <div class="modal fade" id="updateFeedback{{ $f->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            {!! Form::label('email', 'Your Email') !!}
                                            {!! Form::email('email', 'notams@vzcd.org', ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <br>
                                    {!! Form::label('subject', 'Subject') !!}
