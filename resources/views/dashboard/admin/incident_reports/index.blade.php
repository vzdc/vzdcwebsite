...
@section('content')
    ...
    <div class="container">
        <ul class="nav nav-tabs nav-justified" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#archive" role="tab" data-toggle="tab" style="color:black">Archived
                    Reports</a>
            </li>
        </ul>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success simple-tooltip"
                                       href="/dashboard/admin/incident/archive/{{ $r->id }}" data-toggle="tooltip"
                                       title="Archive Report"><i class="fas fa-check"></i></a>
                                    <a class="btn btn-danger simple-tooltip"
                                       href="/dashboard/admin/incident/delete/{{ $r->id }}" data-toggle="tooltip"
                                       title="Delete Report"><i class="fas fa-times"></i></a>
                                    <a class="btn btn-warning simple-tooltip"
                                       href="/dashboard/admin/incident/view/{{ $r->id }}" data-toggle="tooltip"
                                       title="View Report"><i class="fas fa-eye"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    @else
