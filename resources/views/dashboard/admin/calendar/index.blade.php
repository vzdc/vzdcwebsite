...
@section('content')
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs nav-justified" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" href="#calendar" role="tab" data-toggle="tab"
                   style="color:black">Calendar</a>
            </li>
            <li class="nav-item">
                    ...
                    @if(count($calendar) > 0)
                        @foreach($calendar as $c)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <center><a href="/dashboard/admin/calendar/view/{{ $c->id }}">{{ $c->title }}</a>
                                    </center>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-success simple-tooltip"
                                       href="/dashboard/admin/calendar/edit/{{ $c->id }}" data-toggle="tooltip"
                                       title="Edit"><i class="far fa-edit"></i></a>
                                    <button class="btn btn-danger simple-tooltip" type="submit" data-toggle="tooltip"
