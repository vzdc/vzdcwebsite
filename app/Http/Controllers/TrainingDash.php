    ...
    public function saveNewTicket(Request $request)
    {
        ...
        try {
            ...
            return redirect('/dashboard')->with(
                'error', 'Instructor ID: ' . $ticket->instructor_id . ' Date: ' . 
                $ticket->date . ' Position: ' . $ticket->position_central . 'Duration: ' .
                $ticket->duration . ' Notes: ' . $ticket->comments . ' Location: ' . $ticket->type_central . ' Score: ' . $ticket->score
            );
        }
